        ...
        findViewById(R.id.button1).setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if (null == queue)
                {
                    ...
                    queue.add(new FileRequest( "http://zhangmenshiting.baidu.com/data2/music/110015948/1097533661390222861128.mp3?xcode=19a7f4673af5eeb192391a7959859d7fd12cca986ddbfef2", Environment.getExternalStorageDirectory()+"/yyj", "好个.mp3", true, new Listener()
                    {
...
//                            ((ImageView) findViewById(R.id.imageView1)).setImageBitmap((Bitmap)response.result);
                        }
