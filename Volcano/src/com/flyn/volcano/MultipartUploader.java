...
class MultipartUploader implements HttpEntity
{

    private static final String          TAG                      = MultipartUploader.class.getName();
    ...
    public MultipartUploader(IResponseHandler progressHandler)
    {
