...
import com.flyn.volcano.HttpResponseHandler;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        findViewById(R.id.button1).setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                // });
//                RequestParams params = new RequestParams();
//                params.putByteRanges((int) new File(Environment.getExternalStorageDirectory() + "/yyj", "好歌.tmp").length(), 4427185);
                if (null == stack)
                {
                    // String url =
                    // "http://zhangmenshiting.baidu.com/data2/music/109017153/8930817375600128.mp3?xcode=2a9536886231123c387700702f9919cd17c9e7c86eb6cec7";
                    // stack = Volcano.newNetStack(Volcano.TYPE_HTTP_CLIENT,
                    // v.getContext()).makeRequest(Method.POST, null, url, null,
                    // params,
                    // new
                    // FileResponseHandler(Environment.getExternalStorageDirectory()
                    // + "/yyj", "好歌.mp3", true)
                    // {
                    //
                    // @Override
                    ...
                    String url = "http://" + ip + ":8080/upload/upload/execute.do";
                    RequestParams params1 = new RequestParams();
                    params1.put("username", "张三");
                    params1.put("pwd", "zhangsan");
                    params1.put("age", "21");
                    File file = new File(Environment.getExternalStorageDirectory() + "/yyj", "1.mp3");
                    ...
                    Volcano.newNetStack(Volcano.TYPE_HTTP_CLIENT, v.getContext(), false).makeRequest(Method.POST, "application/octet-stream", url, null, params1, new HttpResponseHandler()
                    {
                        
                        @Override
                        public void onSuccess(int statusCode, Map<String, String> headers, byte[] responseBody)
                        {
